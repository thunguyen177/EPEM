...
knn20 = compute_err_knn(X, y, n, p, 10) 
knn20
...
knn30 = compute_err_knn(X, y, n, p, 10) 
knn30
"""## 40%"""
...
knn40 = compute_err_knn(X, y, n, p, 10) 
knn40
...
knn50 = compute_err_knn(X, y, n, p, 10) 
knn50

result = np.vstack((knn20, knn30, knn40, knn50))
print(result)
np.savetxt("fashion_parameter_est_knn.csv", result, delimiter=",")
