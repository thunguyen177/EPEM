...
mice20 = compute_err_MICE(Xtrain, ytrain, Xtest, ytest, n, p, 10)
print("mice20")
print(mice20)
"""## 30%"""
...
mice30 = compute_err_MICE(Xtrain, ytrain, Xtest, ytest, n, p, 10)
print("mice30")
print(mice30)
"""## 40%"""
...
mice40 = compute_err_MICE(Xtrain, ytrain, Xtest, ytest, n, p, 10)
print("mice40")
print(mice40)
...
missing_rate(Xtrain, ytrain, n, p, 10)
mice50 = compute_err_MICE(Xtrain, ytrain, Xtest, ytest, n, p, 10)
print("mice50")
print(mice50)

result = np.vstack((mice20, mice30, mice40, mice50))
np.savetxt("lda_fashion_mice.csv", result, delimiter=",")
